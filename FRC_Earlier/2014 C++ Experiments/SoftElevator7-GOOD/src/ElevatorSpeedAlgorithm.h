...
class ElevatorSpeedAlgorithm {
	const float minVelocityInPercentThatOvercomesMotorInertia = 0.15;  // must be determined by empirical measurement.
	const float accelerationStepSizeInPercent = 0.025;  // Increment used to adjust velocity per per time unit.
