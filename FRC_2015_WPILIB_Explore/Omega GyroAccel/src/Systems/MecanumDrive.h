...
public:
	...
	bool PrepareToAutonDriveStraight();
	CANTalon *FLMotor;
	CANTalon *FRMotor;
	CANTalon *BLMotor;
	CANTalon *BRMotor;
...
private:
	...
	double velocityOnAxisX;
	double velocityOnAxisY;
	double PositionErrorOnAxisX;
	double PositionErrorOnAxisY;

	void ResetAutonGyroAndAccelerometerAnchor(void);
};
